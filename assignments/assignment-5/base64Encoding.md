...
Example 2: Input Requiring 1 Padding Character
    ...
    Input: "Ma"
    Length: 2 characters (16 bits -> needs 2 bits zero-padding to make 18 bits, plus = to complete 4-character output block)
...
Add Padding	Append = to make total length 4
Final Output	TWE=
Test Cases
Input String	Expected Base64 Output	Notes
"Cat"	"Q2F0"	Exact multiple of 3 bytes
"Hello World"	"SGVsbG8gV29ybGQ="	11 bytes -> 1 = padding
"A"	"QQ=="	1 byte -> 2 = padding
""	""	Empty input yields empty string
Optional Bonus Challenge

    Decode Function: Add a second function that reverses the process and decodes a Base64 string back to original text.
